    ...
    <div className="relative z-10 container  p-4 md:px-8 rounded-3xl">
      ...
      <div className="flex items-center space-x-2 mt-4">
        ...
        <label htmlFor="gift-wrap" className="text-sm text-gray-700">
          I confirm that I have read and accept the <a href="/policies/terms-and-conditions" className="text-blue-400 hover:underline"> terms and conditions</a> and
          <a href="/policies/shipping" className="text-blue-400 hover:underline"> privacy policy</a>.
        </label>
      </div>
