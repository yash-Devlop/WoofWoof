...
const FeatureProfile = () => {
  ...
  const handleNext = () => {
    if (startIndex + itemsPerPage < featuredProfileData.length) {
  ...
  const visibleProfiles = featuredProfileData.slice(
    startIndex,
        ...
        <div className="px-4 md:px-20 xl:px-40">
          <div className="flex w-full justify-between mb-8">
            ...
            <div className="flex gap-3">
              ...
              <div
                className={`cursor-pointer ${
                  startIndex + itemsPerPage >= featuredProfileData.length
              ...
              {visibleProfiles.map((profile, index) => (
                ...
                >
                  <Image
                    ...
                    width={300}
                    height={300}
                    className="rounded-t-2xl object-cover lg:w-full h-[100px] md:h-[150px] lg:h-[250px]"
                  />
                  <div className="flex justify-between p-2 md:p-4 rounded-b-2xl bg-gray-100 mt-1 mb-3">
                    <div className="text-lg font-semibold">{profile.name}</div>
                    <div className="cursor-pointer">
