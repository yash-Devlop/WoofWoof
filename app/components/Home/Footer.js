...
//           className="w-full relative py-8 md:py-16"
//         >
//           <div className="px-4 md:px-16 xl:px-40 space-y-12">
//             <div className="grid grid-cols-1 lg:grid-cols-[30%_70%] lg:gap-16 gap-10 justify-center items-start">
...
//                   />
//                 </div>
//                 <div className="text-center lg:text-left text-gray-300 leading-relaxed">
...
//                     <div
//                       className="cursor-pointer hover:underline text-gray-300 hover:text-white transition-colors"
//                       onClick={() => router.push("/aboutUs")}
//                     >
//                       About Us
//                     </div>
//                     <div className="hover:underline cursor-pointer text-gray-300 hover:text-white transition-colors">
...
//                   <div className="space-y-3">
//                     <div className="font-bold text-lg mb-4">Useful Links</div>
//                     <div
//                       className="cursor-pointer hover:underline text-gray-300 hover:text-white transition-colors"
...
//                       Shop
//                     </div>
//                     <div className="cursor-pointer hover:underline text-gray-300 hover:text-white transition-colors">
//                       Best Seller
//                     </div>
//                     <div
//                       className="cursor-pointer hover:underline text-gray-300 hover:text-white transition-colors"
...
//                   <div className="space-y-3">
//                     <div className="font-bold text-lg mb-4">Customer Support</div>
//                     <div
//                       className="cursor-pointer hover:underline text-gray-300 hover:text-white transition-colors"
...
//                     <div className="flex items-center gap-2 hover:underline cursor-pointer text-gray-300 hover:text-white transition-colors">
//                       <Phone size={16} />
//                       <a href="tel:+919318493050">+91 93184 93050</a>
//                     </div>
...
//                         className="hover:underline cursor-pointer text-gray-300 hover:text-white transition-colors break-all"
//                       >
//                         contact@woofwoof.in
//                       </a>
//                     </div>

//                     <a href="/blueocean"><div className="font-bold text-lg mt-6 mb-3">Blue Ocean</div></a>

//                     <div className="flex items-start gap-2 text-gray-300 text-sm leading-relaxed">
//                       <MapPin size={16} className="mt-1 flex-shrink-0" />
//                       <div>
//                         OMAXE WORLD STREET, SCO: 151, (FIRST FLOOR) ABOVE AIRTEL,
//                         SECTOR 79, FARIDABAD 121004, HARYANA, INDIA.
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//               <div className="flex justify-center md:justify-between items-center gap-6 flex-col md:flex-row">
//                 <div className="text-gray-400 text-sm">
//                   © Copyright Woof Woof 2025. All rights reserved.
//                 </div>
//                 <Image
      ...
      <div className="relative bg-[#292929] rounded-3xl text-white overflow-hidden">
        ...
        >
          <div className="px-4 md:px-16 xl:px-40 space-y-12">
            ...
            {/* Blue Ocean Section - Centered without border */}
            <div className="pt-8">
              <div className="text-center space-y-4">
                <a href="/blueocean">
                  <div className="font-bold text-2xl md:text-3xl hover:text-gray-300 transition-colors">
                    Blue Ocean
                  </div>
                </a>

                <div className="flex items-start gap-3 text-gray-300 text-sm leading-relaxed justify-center">
