...
//               </div>
//             ) : (
//               // ✅ Replace video with Instagram feed
//               <div className="relative w-full h-[600px] md:h-[700px]">
//                 <iframe
//                   src="https://snapwidget.com/embed/123456" // 🔁 Replace this with your SnapWidget or LightWidget link
      ...
      <div className="bg-white rounded-3xl m-4 md:m-12 py-6">
        <div className="px-4 md:px-24 xl:px-40">
          <div className="relative w-full max-w-5xl mx-auto rounded-3xl overflow-hidden">
            <div className="relative w-full h-[600px] md:h-[700px]">
              <iframe
                src="https://www.youtube.com/embed/6v4OgilckIc"
                className="w-full h-full border-none rounded-3xl"
