          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            ...
            <div className="mx-auto max-w-md">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {product.sizes.map((size) => (
                      <button
                        key={size}
                        onClick={() => setSelectedSize(size)}
                        className={`border rounded px-2 py-1 text-sm hover:bg-[#F91F54] hover:text-white transition ${
                          selectedSize === size
                            ? "bg-[#F91F54] text-white"
                            : "text-gray-700"
                        }`}
              ...
              <div className="flex items-center gap-4 mt-6 flex-wrap">
                ...
                <button
                  onClick={handleBuy}
                  className="bg-[#F91F54] hover:bg-[#d20037] text-white px-4 py-1 rounded cursor-pointer transition-colors"
                >
                  Buy Now
                </button>
                <button
